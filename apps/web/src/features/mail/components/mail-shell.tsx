...
function DeliveryNotice() {
  ...
  return (
    <div className="animate-in slide-in-from-bottom-3 fixed right-5 bottom-5 z-50 flex items-center gap-3 rounded-full bg-[var(--mail-brand)] py-2.5 pr-2.5 pl-4 text-sm text-[var(--mail-brand-foreground)] shadow-2xl duration-300">
      <span className="size-1.5 rounded-full bg-[var(--mail-highlight)]" />
      <span>{notice}</span>
      <button
