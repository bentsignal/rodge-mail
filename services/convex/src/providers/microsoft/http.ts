/* eslint-disable complexity, max-lines-per-function, no-restricted-syntax, @typescript-eslint/consistent-type-assertions -- The unauthenticated callback validates explicit OAuth and Graph response contracts. */
